...
public class ResumeResponseDTO implements ResponseDTO {
    ...
    public ResumeResponseDTO(ResumeJson resumeJson) {
        ...
        switch (resumeJson.getJson_count()) {
            case 10:
                list.add(resumeJson.getJson_10());
            case 9:
                list.add(0, resumeJson.getJson_9());
            case 8:
                list.add(0, resumeJson.getJson_8());
            case 7:
                list.add(0, resumeJson.getJson_7());
            case 6:
                list.add(0, resumeJson.getJson_6());
            case 5:
                list.add(0, resumeJson.getJson_5());
            case 4:
                list.add(0, resumeJson.getJson_4());
            case 3:
                list.add(0, resumeJson.getJson_3());
            case 2:
                list.add(0, resumeJson.getJson_2());
            case 1:
                list.add(0, resumeJson.getJson_1());
        }
