...
public class TagController {
    ...
    public ResponseEntity addTags(@RequestBody TagRequestDTO tagRequestDTO)throws NotFoundException{
        recommendService.addTag(tagRequestDTO.getLabelCode(),tagRequestDTO.getTargetType(),tagRequestDTO.getId());
        return ResponseEntity.ok(new Response(new StatusDTO(201, "success")));
    }

    @DeleteMapping
    public ResponseEntity deleteTags( @RequestBody TagRequestDTO tagRequestDTO)throws NotFoundException{
        recommendService.deleteTag(tagRequestDTO.getLabelCode(),tagRequestDTO.getTargetType(),tagRequestDTO.getId());
        return ResponseEntity.ok(new Response(new StatusDTO(201, "success")));
    }
}
