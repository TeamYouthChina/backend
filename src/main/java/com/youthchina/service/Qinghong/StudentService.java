...
public interface StudentService extends DomainCRUDService<Student, Integer> {
    ...
    Integer jobApply(Integer job_id,Integer user_id) throws NotFoundException;
    ...
    Integer deleteJobCollect(Integer id) throws NotFoundException;
    Integer deleteCompCollect(Integer id) throws NotFoundException;
