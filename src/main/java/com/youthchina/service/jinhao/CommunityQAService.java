...
public interface CommunityQAService extends DomainCRUDService<Question, Integer> {
    ...
    void attentionQuestion(Integer ques_id, Integer user_id) throws NotFoundException;
...
//    Integer acceptOrRefuseInvitation(AnswerInvitation answerInvitation) throws NotFoundException;
    ...
    Answer addAnswer(Answer answer, Integer ques_id, Integer answer_level) throws NotFoundException;
    Answer getAnswer(Integer answer_id) throws NotFoundException;
    Answer editAnswer(Answer answer) throws NotFoundException;
    void deleteAnswer(Integer answer_id) throws NotFoundException;
    List<Answer> listMyAnswers(Integer user_id) throws NotFoundException;
...
//    List<Answer> listMyAgreeAnswer(Integer user_id) throws NotFoundException;
...
//    Evaluate discussEvaluateStatus(Integer user_id, Integer discuss_id) throws NotFoundException;
//    Integer evaluateDiscuss(Integer discuss_id, Evaluate discussEvaluate) throws NotFoundException;
    ...
    void attentionVideo(Integer user_id, Integer video_id) throws NotFoundException;
    void cancelAttenVideo(Integer user_id, Integer video_id) throws NotFoundException;

    Comment commentVideo(Comment comment, Integer video_id, Integer comment_level) throws NotFoundException;
    Comment getVideoComment(Integer comment_id) throws NotFoundException;
    void deleteVideoComment(Integer comment_id) throws NotFoundException;

   void evaluateVideo(Integer user_id, Integer video_id) throws NotFoundException;
