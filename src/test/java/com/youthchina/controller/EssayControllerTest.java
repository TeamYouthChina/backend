...
public class EssayControllerTest extends BaseControllerTest {
    ...
    public void addCommentTest() throws Exception {
        this.mvc.perform(
                ...
                .andDo(print())
                .andExpect(partialContent("{\"content\":{\"id\":27,\"creator\":{\"id\":1,\"email\":\"123456@123.com\",\"register_date\":1546300800000,\"date_of_birth\":0,\"first_name\":\"Admin\",\"last_name\":\"Admin\",\"gender\":\"MALE\",\"nation\":\"CHN\",\"avatar_url\":\"---\",\"role\":[\"ROOT\"],\"phone_number\":\"1234657890123\"},\"body\":\"何老师你要是被绑架了就扎扎眼！\",\"create_at\":1557118054000,\"is_anonymous\":false,\"modified_at\":1557118054000,\"upvoteCount\":0,\"downvoteCount\":0,\"evaluateStatus\":3},\"status\":{\"code\":201,\"reason\":\"success\"}}", "$.content.id", "$.content.modified_at", "$.content.create_at"));
    }
