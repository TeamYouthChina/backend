...
public class QuestionControllerTest {
    ...
    public void getAnswersTest() throws Exception {
        this.mvc.perform(
                ...
                .andDo(print())
                .andExpect(content().json("{\"content\":{\"answers\":[{\"body\":{\"braftEditorRaw\":null,\"previewText\":\"这是第五个回答\",\"resourceList\":null},\"is_anonymous\":false}]},\"status\":{\"code\":2000,\"reason\":\"\"}}", false));
    }
