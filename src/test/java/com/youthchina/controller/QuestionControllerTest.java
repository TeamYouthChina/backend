...
public class QuestionControllerTest {
    ...
    public void testAddquestion() throws Exception {
        ...
        questionDTO.setTitle("第一百个问题");
        questionDTO.setBody("balabalabalabala");
        questionDTO.setRela_type(1);
        questionDTO.setAbbre("第一百个问题描述");
        questionDTO.setCreateAt(new Timestamp(System.currentTimeMillis()));
        questionDTO.setEditTime(new Timestamp(System.currentTimeMillis()));
        questionDTO.setAnonymous(0);

        ObjectMapper mapper = new ObjectMapper();
        ObjectWriter ow = mapper.writer().withDefaultPrettyPrinter();
        java.lang.String searchJson = ow.writeValueAsString(questionDTO);
