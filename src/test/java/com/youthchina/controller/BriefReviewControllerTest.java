...
public class BriefReviewControllerTest {
    ...
    public void updateBriefReviewTest() throws Exception {
        ...
        this.mvc.perform(
                ...
                .andDo(print())
                .andExpect(partialContent("{\"content\":{\"id\":1,\"body\":{\"braftEditorRaw\":\"ttererer\",\"previewText\":\"pre\",\"compiletype\":1},\"comments\":[{\"id\":1,\"creator\":{\"id\":2,\"email\":\"123456@456.com\",\"register_date\":1546300800000,\"date_of_birth\":0,\"first_name\":\"DDD\",\"last_name\":\"DDDEEEFFF\",\"gender\":\"FEMALE\",\"nation\":\"USA\",\"avatar_url\":\"---\",\"role\":[\"ADMIN\"],\"phone_number\":\"9876543210123\"},\"body\":\"短评评论1\",\"create_at\":1517616000000,\"is_anonymous\":false,\"modified_at\":1517616000000,\"upvoteCount\":0,\"downvoteCount\":0,\"evaluateStatus\":3}],\"author\":{\"id\":1,\"email\":\"123456@123.com\",\"register_date\":1546300800000,\"date_of_birth\":0,\"first_name\":\"Admin\",\"last_name\":\"Admin\",\"gender\":\"MALE\",\"nation\":\"CHN\",\"avatar_url\":\"---\",\"role\":[\"ROOT\"],\"phone_number\":\"1234657890123\"},\"upvoteCount\":0,\"downvoteCount\":2,\"attentionCount\":4,\"evaluateStatus\":3,\"modified_at\":1557118051000,\"attention\":false},\"status\":{\"code\":200,\"reason\":\"success\"}}","$.content.modified_at"));
    ...
    public void addBriefReviewTest() throws Exception {
        ...
        this.mvc.perform(
                ...
                .andDo(print())
                .andExpect(partialContent("{\"content\":{\"id\":5,\"body\":{\"braftEditorRaw\":\"erer\",\"previewText\":\"pre\",\"compiletype\":1},\"comments\":[{\"id\":5,\"creator\":null,\"body\":\"短评评论5\",\"create_at\":1550016000000,\"is_anonymous\":true,\"modified_at\":1550016000000,\"upvoteCount\":0,\"downvoteCount\":0,\"evaluateStatus\":3}],\"author\":{\"id\":1,\"email\":\"123456@123.com\",\"register_date\":1546300800000,\"date_of_birth\":0,\"first_name\":\"Admin\",\"last_name\":\"Admin\",\"gender\":\"MALE\",\"nation\":\"CHN\",\"avatar_url\":\"---\",\"role\":[\"ROOT\"],\"phone_number\":\"1234657890123\"},\"upvoteCount\":0,\"downvoteCount\":0,\"attentionCount\":0,\"evaluateStatus\":3,\"modified_at\":1557118051000,\"attention\":false},\"status\":{\"code\":201,\"reason\":\"success\"}}","$.content.modified_at","$.content.id","$.content.comments"));
    ...
    public void getBriefReviewCommentsTest() throws Exception {
        this.mvc.perform(
                ...
                .andDo(print())
                .andExpect(content().json("{\"content\":{\"offset\":0,\"limit\":2147483646,\"data\":[{\"id\":1,\"creator\":{\"id\":2,\"email\":\"123456@456.com\",\"register_date\":1546300800000,\"date_of_birth\":0,\"first_name\":\"DDD\",\"last_name\":\"DDDEEEFFF\",\"gender\":\"FEMALE\",\"nation\":\"USA\",\"avatar_url\":\"---\",\"role\":[\"ADMIN\"],\"phone_number\":\"9876543210123\"},\"body\":\"短评评论1\",\"create_at\":1517616000000,\"is_anonymous\":false,\"modified_at\":1517616000000,\"upvoteCount\":0,\"downvoteCount\":0,\"evaluateStatus\":3}],\"page_count\":0,\"item_count\":1,\"page_index\":0,\"is_first\":true,\"is_last\":false},\"status\":{\"code\":2000,\"reason\":\"\"}}", false));
