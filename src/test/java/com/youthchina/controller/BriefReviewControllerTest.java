...
public class BriefReviewControllerTest {
    ...
    public void updateBriefReviewTest() throws Exception {
        ...
        this.mvc.perform(
                ...
                .andDo(print())
                .andExpect(partialContent("{\"content\":{\"id\":1,\"body\":{\"braftEditorRaw\":\"ttererer\",\"previewText\":\"pre\",\"compiletype\":1},\"comments\":[{\"id\":1,\"creator\":{\"id\":2,\"email\":\"Admin2\",\"register_date\":1546300800000,\"date_of_birth\":0,\"first_name\":\"Admin2\",\"last_name\":\"Admin2\",\"gender\":\"FEMALE\",\"avatar_url\":\"---\",\"role\":[\"ROOT\"],\"phone_number\":\"23456\"},\"body\":\"短评评论1\",\"create_at\":1517616000000,\"is_anonymous\":false,\"modified_at\":1517616000000,\"upvoteCount\":0,\"downvoteCount\":0,\"evaluateStatus\":3}],\"author\":{\"id\":1,\"email\":\"Admin1\",\"register_date\":1546300800000,\"date_of_birth\":0,\"first_name\":\"Admin1\",\"last_name\":\"Admin1\",\"gender\":\"MALE\",\"avatar_url\":\"---\",\"role\":[\"ROOT\"],\"phone_number\":\"12345\"},\"upvoteCount\":0,\"downvoteCount\":2,\"attentionCount\":4,\"evaluateStatus\":3,\"modified_at\":1558000388000,\"attention\":false},\"status\":{\"code\":200,\"reason\":\"success\"}}","$.content.modified_at"));
    ...
    public void getBriefReviewCommentsTest() throws Exception {
        this.mvc.perform(
                ...
                .andDo(print())
                .andExpect(content().json("{\"content\":{\"offset\":0,\"limit\":2147483646,\"data\":[{\"id\":1,\"creator\":{\"id\":2,\"email\":\"Admin2\",\"register_date\":1546300800000,\"date_of_birth\":0,\"first_name\":\"Admin2\",\"last_name\":\"Admin2\",\"gender\":\"FEMALE\",\"avatar_url\":\"---\",\"role\":[\"ROOT\"],\"phone_number\":\"23456\"},\"body\":\"短评评论1\",\"create_at\":1517616000000,\"is_anonymous\":false,\"modified_at\":1517616000000,\"upvoteCount\":0,\"downvoteCount\":0,\"evaluateStatus\":3}],\"page_count\":0,\"item_count\":1,\"page_index\":0,\"is_first\":true,\"is_last\":false},\"status\":{\"code\":2000,\"reason\":\"\"}}", false));
