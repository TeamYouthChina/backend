...
public class BriefReviewControllerTest {
    ...
    public void updateBriefReviewTest() throws Exception {
        ...
        this.mvc.perform(
                ...
                .andDo(print())
                .andExpect(partialContent("{\"content\":{\"id\":1,\"body\":{\"braftEditorRaw\":\"ttererer\",\"previewText\":\"pre\",\"compiletype\":1},\"comments\":[{\"id\":1,\"creator\":{\"id\":2,\"username\":\"DEF\",\"email\":\"123456@456.com\",\"register_date\":1546300800000,\"first_name\":\"DDD\",\"last_name\":\"DDDEEEFFF\",\"gender\":\"Female\",\"nation\":\"USA\",\"avatar_url\":\"---\",\"role\":[\"ADMIN\"],\"age\":28,\"phone_number\":\"9876543210123\"},\"body\":\"短评评论1\",\"create_at\":1517616000000,\"is_anonymous\":false,\"modified_at\":1517616000000,\"upvoteCount\":0,\"downvoteCount\":0,\"evaluateStatus\":3}],\"author\":{\"id\":1,\"username\":\"Admin\",\"email\":\"123456@123.com\",\"register_date\":1546300800000,\"first_name\":\"Admin\",\"last_name\":\"Admin\",\"gender\":\"Male\",\"nation\":\"CHN\",\"avatar_url\":\"---\",\"role\":[\"ROOT\"],\"age\":25,\"phone_number\":\"1234657890123\"},\"upvoteCount\":0,\"downvoteCount\":2,\"attentionCount\":4,\"evaluateStatus\":3,\"modified_at\":1555504820000,\"attention\":false},\"status\":{\"code\":200,\"reason\":\"success\"}}","$.content.modified_at"));
    ...
    public void addBriefReviewTest() throws Exception {
        ...
        this.mvc.perform(
                ...
                .andDo(print())
                .andExpect(partialContent("{\"content\":{\"id\":9,\"body\":{\"braftEditorRaw\":\"erer\",\"previewText\":\"pre\",\"compiletype\":1},\"comments\":[],\"author\":{\"id\":1,\"username\":\"Admin\",\"email\":\"123456@123.com\",\"register_date\":1546300800000,\"first_name\":\"Admin\",\"last_name\":\"Admin\",\"gender\":\"Male\",\"nation\":\"CHN\",\"avatar_url\":\"---\",\"role\":[\"ROOT\"],\"age\":25,\"phone_number\":\"1234657890123\"},\"upvoteCount\":0,\"downvoteCount\":0,\"attentionCount\":0,\"evaluateStatus\":3,\"modified_at\":1555504819000,\"attention\":false},\"status\":{\"code\":201,\"reason\":\"success\"}}","$.content.modified_at","$.content.id","$.content.comments"));
