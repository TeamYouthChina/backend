...
public class BriefReviewControllerTest {
    ...
    public void addBriefReviewTest() throws Exception {
        ...
        this.mvc.perform(
                ...
                .andDo(print())
                .andExpect(partialContent("{\"content\":{\"id\":5,\"body\":{\"braftEditorRaw\":\"erer\",\"previewText\":\"pre\",\"compiletype\":1},\"comments\":[{\"id\":5,\"creator\":null,\"body\":\"��������5\",\"create_at\":1550016000000,\"is_anonymous\":true,\"modified_at\":1550016000000,\"upvoteCount\":0,\"downvoteCount\":0,\"evaluateStatus\":3}],\"author\":{\"id\":1,\"email\":\"Admin1\",\"register_date\":1546300800000,\"date_of_birth\":0,\"first_name\":\"Admin1\",\"last_name\":\"Admin1\",\"gender\":\"MALE\",\"avatar_url\":\"---\",\"role\":[\"ROOT\"],\"phone_number\":\"12345\"},\"upvoteCount\":0,\"downvoteCount\":0,\"attentionCount\":0,\"evaluateStatus\":3,\"modified_at\":1557999100000,\"attention\":false},\"status\":{\"code\":201,\"reason\":\"success\"}}","$.content.modified_at","$.content.id","$.content.comments"));
