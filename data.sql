...
`CERTIFICATE_URL` VARCHAR(200) NOT NULL COMMENT '证书上传地址',
...
`EVALU_CONTENT` INTEGER NOT NULL COMMENT '评价内容',
...
`UNIVERS_CHN` VARCHAR(200) NOT NULL COMMENT '中文名称',
`UNIVERS_ENG` VARCHAR(200) NOT NULL COMMENT '英文名称',
`UNIVERS_COUNTRY` VARCHAR(10) COMMENT '学校国别',
...
`COMPANY_CHN` VARCHAR(200) NOT NULL COMMENT '中文名称',
`COMPANY_ENG` VARCHAR(200) NOT NULL COMMENT '英文名称',
