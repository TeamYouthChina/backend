...
`DOCU_SERVER_ALI_ID` VARCHAR(100) NOT NULL COMMENT '服务器1文件编号',
`DOCU_SERVER_AWS_ID` VARCHAR(100) NOT NULL COMMENT '服务器2文件编号',
...
create table IF NOT EXISTS `COMPANY_INFO` (
  ...
  COMMENT '企业国别',
  `COMPANY_INTRODUC`   VARCHAR(400) COMMENT '企业简介',
...
`REVIEW_CONTENT` VARCHAR(2000) NOT NULL COMMENT '短评内容',
...
`QUES_TITLE` VARCHAR(200) COMMENT '问题标题',
`DATA_TIME` TIMESTAMP COMMENT '数据日期'
)COMMENT = '问题推荐表';
