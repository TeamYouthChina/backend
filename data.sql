...
`JSON_1` VARCHAR(500) NOT NULL COMMENT 'json1',
`JSON_2` VARCHAR(500) NOT NULL COMMENT 'json2',
`JSON_3` VARCHAR(500) NOT NULL COMMENT 'json3',
`JSON_4` VARCHAR(500) NOT NULL COMMENT 'json4',
`JSON_5` VARCHAR(500) NOT NULL COMMENT 'json5',
`JSON_6` VARCHAR(500) NOT NULL COMMENT 'json6',
`JSON_7` VARCHAR(500) NOT NULL COMMENT 'json7',
`JSON_8` VARCHAR(500) NOT NULL COMMENT 'json8',
`JSON_9` VARCHAR(500) NOT NULL COMMENT 'json9',
`JSON_10` VARCHAR(500) NOT NULL COMMENT 'json10',
`CREATE_TIME` TIMESTAMP NOT NULL COMMENT '生成时间',
`IS_DELETE` INTEGER DEFAULT '0' COMMENT '是否删除',
`IS_DELETE_TIME` TIMESTAMP NULL DEFAULT NULL COMMENT '删除时间',
PRIMARY KEY (`RESUME_ID`)
...
`ANSWER_CONTENT` VARCHAR(5000) NOT NULL COMMENT '回答内容',
...
`REPLY_CONTENT` VARCHAR(5000) NOT NULL COMMENT '回复内容',
...
`REVIEW_CONTENT` VARCHAR(200) NOT NULL COMMENT '短评内容',
...
`ESSAY_ID` INT COMMENT '问题ID',
`ESSAY_TITLE` VARCHAR(200) COMMENT '问题标题',
`DATA_TIME` TIMESTAMP COMMENT '数据日期'
)COMMENT = '问题推荐表';
...
`COMPANY_ID` INT AUTO_INCREMENT COMMENT '企业ID',
`COMPANY_NAME` VARCHAR(200) NOT NULL COMMENT '企业名称',
`COMPANY_INTRODUC` VARCHAR(200) COMMENT '企业简介',
`COMPANY_NATURE` VARCHAR(200) NOT NULL COMMENT '企业性质',
`COMPANY_LOCATION` VARCHAR(200) NOT NULL COMMENT '企业所在地',
`COMPANY_WEBSITE` VARCHAR(200) COMMENT '企业官网',
`COMPANY_START_DATE` DATE COMMENT '成立日期',
`COMPANY_LOGO` VARCHAR(200) COMMENT '企业LOGO',
`JOB_ID` INTEGER NOT NULL COMMENT '职位ID',
`JOB_NAME` VARCHAR(200) NOT NULL COMMENT '职位名称',
`JOB_TIME` INTEGER NOT NULL COMMENT '职位性质',
`DATA_TIME` TIMESTAMP NOT NULL COMMENT '数据日期',
PRIMARY KEY (`COMPANY_ID`)
)COMMENT = '校园招聘表';
